...
class Dungeon {
    ...
    update(dt) {
        ...
        /* El impulso solo vale moviendose y de pie: agachado o deslizandote ya
        ...
        this.running = (wantRun || this.boosting) && moving > 0.05;
        ...
        const wantFov = FOV - enc * 7 + (this.running ? 6 : 0) + (this.boosting ? 10 : 0) + (sliding ? 22 * slideK : 0) - emb * 18;
