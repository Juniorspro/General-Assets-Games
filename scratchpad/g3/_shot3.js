...
(async()=>{
  ...
  await pg.goto('http://127.0.0.1:8951/scratchpad/g3/arc-furia.html?local',{waitUntil:'load'});
  await sleep(4500);
  await pg.evaluate(()=>window.__ARC.goMenu()); await sleep(900);
  await pg.screenshot({path:'furia-menu.png'});
  ...
  await sleep(200);
  await pg.screenshot({path:'furia-game.png'});
