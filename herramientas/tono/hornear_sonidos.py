...
`partes/i_son.js`.
    ...
    python3 herramientas/tono/hornear_sonidos.py
...
El panel abarca dos octavas (25 semitonos). Con muestras cada doce semitonos, lo
...
INSTR = [
  ...
  ('teclas',  'harpsichord',            48, 0, 'Clavecín',     'Harpsichord',   'Cravo'),
  ('teclas',  'clavinet',               48, 0, 'Clavinet',     'Clavinet',      'Clavinete'),
  ('campana', 'celesta',                60, 0, 'Celesta',      'Celesta',       'Celesta'),
  ('campana', 'glockenspiel',           60, 0, 'Glockenspiel', 'Glockenspiel',  'Glockenspiel'),
  ('campana', 'music_box',              60, 0, 'Cajita',       'Music box',     'Caixinha'),
  ('campana', 'tubular_bells',          48, 0, 'Campanas',     'Tubular bells', 'Sinos'),
  ('madera',  'marimba',                48, 0, 'Marimba',      'Marimba',       'Marimba'),
  ('madera',  'xylophone',              60, 0, 'Xilófono',     'Xylophone',     'Xilofone'),
  ('madera',  'vibraphone',             48, 0, 'Vibráfono',    'Vibraphone',    'Vibrafone'),
  ('madera',  'kalimba',                60, 0, 'Kalimba',      'Kalimba',       'Kalimba'),
  ('organo',  'drawbar_organ',          48, 1, 'Órgano',       'Drawbar organ', 'Órgão'),
  ('organo',  'church_organ',           48, 1, 'Órgano de igl.','Church organ', 'Órgão de igreja'),
  ('organo',  'accordion',              48, 1, 'Acordeón',     'Accordion',     'Acordeão'),
  ('organo',  'harmonica',              48, 1, 'Armónica',     'Harmonica',     'Gaita'),
  ('pulsada', 'acoustic_guitar_nylon',  48, 0, 'Guitarra',     'Nylon guitar',  'Violão'),
  ('pulsada', 'electric_guitar_clean',  48, 0, 'Guitarra eléc.','Clean guitar', 'Guitarra elétr.'),
  ('pulsada', 'orchestral_harp',        48, 0, 'Arpa',         'Harp',          'Harpa'),
  ('pulsada', 'sitar',                  48, 0, 'Sitar',        'Sitar',         'Sitar'),
  ('viento',  'flute',                  60, 1, 'Flauta',       'Flute',         'Flauta'),
  ('viento',  'clarinet',               48, 1, 'Clarinete',    'Clarinet',      'Clarinete'),
  ('viento',  'pan_flute',              60, 1, 'Siku',         'Pan flute',     'Flauta de pã'),
  ('viento',  'shakuhachi',             60, 1, 'Shakuhachi',   'Shakuhachi',    'Shakuhachi'),
  ('arco',    'violin',                 55, 1, 'Violín',       'Violin',        'Violino'),
  ('arco',    'cello',                  43, 1, 'Cello',        'Cello',         'Violoncelo'),
  ('arco',    'string_ensemble_1',      48, 1, 'Cuerdas',      'Strings',       'Cordas'),
  ('arco',    'trumpet',                48, 1, 'Trompeta',     'Trumpet',       'Trompete'),
  ('sinte',   'electric_bass_finger',   36, 0, 'Bajo',         'Bass',          'Baixo'),
  ('sinte',   'synth_bass_1',           36, 1, 'Bajo sinte',   'Synth bass',    'Baixo sint.'),
