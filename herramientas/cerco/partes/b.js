...
const LANGS = {
  es: {
    ...
    tutTit: 'TUTORIAL',
    tut1: 'apoyá el dedo y empujá · el cuerpo va hacia donde apuntás',
  ...
  en: {
    ...
    tutTit: 'TUTORIAL',
    tut1: 'press and push · the body goes where you point',
  ...
  pt: {
    ...
    tutTit: 'TUTORIAL',
    tut1: 'apoie o dedo e empurre · o corpo vai para onde aponta',
