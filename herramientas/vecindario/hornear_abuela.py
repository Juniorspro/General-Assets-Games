# -*- coding: utf-8 -*-
"""
Hornea el GLB de la abuela (mismo horno que el de Baldi, mismos motivos) generado con Higgsfield (Meshy image_to_3d, riggeado y texturizado) para que
...
ENT  = os.path.join(RAIZ, 'herramientas', 'vecindario', 'abuela.glb')
SAL  = os.path.join(RAIZ, 'herramientas', 'vecindario', 'abuela_p.glb')
TEX_LADO = 512
TEX_Q = 82
...
def main():
    ...
    print('animaciones tiradas: %d' % n_anim)
