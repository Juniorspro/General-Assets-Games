# -*- coding: utf-8 -*-
"""
Hornea el GLB de Baldi generado con Higgsfield (Meshy image_to_3d, riggeado y texturizado) para que
...
ENT  = os.path.join(RAIZ, 'assets', 'recreo', 'baldi.glb')
SAL  = os.path.join(RAIZ, 'assets', 'recreo', 'baldi_p.glb')
TEX_LADO = 512
TEX_Q = 82
