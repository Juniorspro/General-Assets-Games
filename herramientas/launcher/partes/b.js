...
const TXT = {
  es: { s_madrugada: 'Buenas noches', s_manana: 'Buen día', s_tarde: 'Buenas tardes', s_noche: 'Buenas noches',
        ...
        pPack: 'Pack Aero de iconos', pIcono: 'Fondo de los iconos', pAgua: 'Agua', pPasto: 'Pasto', pNube: 'Nubes',
        /* ── la cámara Aero ── */
  ...
  en: { s_madrugada: 'Good night', s_manana: 'Good morning', s_tarde: 'Good afternoon', s_noche: 'Good evening',
        ...
        pPack: 'Aero icon pack', pIcono: 'Icon backdrop', pAgua: 'Water', pPasto: 'Grass', pNube: 'Clouds',
  ...
  pt: { s_madrugada: 'Boa noite', s_manana: 'Bom dia', s_tarde: 'Boa tarde', s_noche: 'Boa noite',
        ...
        pPack: 'Pacote de ícones Aero', pIcono: 'Fundo dos ícones', pAgua: 'Água', pPasto: 'Grama', pNube: 'Nuvens',
