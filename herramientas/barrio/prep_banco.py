...
"""Deja el HTML listo para el banco de pruebas del contenedor.
    ...
    python3 herramientas/barrio/prep_banco.py juegos-pc/Barrio.html /tmp/ui/barrio.html

VIVE EN EL REPO Y NO EN /tmp A PROPOSITO. El `prep2.py` del banco reescribe los
CDN de unpkg, y BARRIO importa three desde jsDelivr, asi que habia que parchearlo
