...
const LANG={
 en:{
  ...
  graficos:'GRAPHICS',
  volver:'BACK',
  modoBots:'AGAINST BOTS',
  modoMulti:'1 vs 1 ONLINE',
  modoPie:'Two bots, offline · or one real person in the same room code.',
  salaT:'ROOM CODE',
  salaPie:'Share this code. The other player types it and you both get in.',
  conectar:'CONNECT',
  mpNo:'offline',
  mpConectando:'connecting…',
  mpOnline:'online · waiting for the other player',
  mpDos:'{n} joined · starting',
  mpOffline:'no connection · check the network',
  mpErr:'the relay did not answer',
  mpSinLib:'the multiplayer library did not load',
  mpSalio:'{n} left the game',
  chat1:'hi!', chat2:'nice one', chat3:'ugh', chat4:'gg',
  calBaja:'LOW',
  calMedia:'MEDIUM',
  calAlta:'HIGH',
 ...
 es:{
  ...
  graficos:'GRÁFICOS',
  volver:'VOLVER',
  modoBots:'CONTRA BOTS',
  modoMulti:'1 vs 1 EN LÍNEA',
  modoPie:'Dos bots, sin conexión · o una persona de verdad con el mismo código de sala.',
  salaT:'CÓDIGO DE SALA',
  salaPie:'Pasale este código al otro. Lo escribe y entran los dos.',
  conectar:'CONECTAR',
  mpNo:'sin conexión',
  mpConectando:'conectando…',
  mpOnline:'en línea · esperando al otro jugador',
  mpDos:'entró {n} · arrancando',
  mpOffline:'sin conexión · fijate la red',
  mpErr:'el relevo no contestó',
  mpSinLib:'no cargó la biblioteca de multijugador',
  mpSalio:'{n} se fue de la partida',
  chat1:'¡hola!', chat2:'buena', chat3:'uf', chat4:'gg',
  calBaja:'BAJA',
  calMedia:'MEDIA',
  calAlta:'ALTA',
 ...
 pt:{
  ...
  modoBots:'CONTRA BOTS',
  modoMulti:'1 vs 1 ONLINE',
  modoPie:'Dois bots, sem conexão · ou uma pessoa de verdade com o mesmo código de sala.',
  salaT:'CÓDIGO DA SALA',
  salaPie:'Passe este código ao outro. Ele digita e vocês dois entram.',
  conectar:'CONECTAR',
  mpNo:'sem conexão',
  mpConectando:'conectando…',
  mpOnline:'online · esperando o outro jogador',
  mpDos:'{n} entrou · começando',
  mpOffline:'sem conexão · veja a rede',
  mpErr:'o relé não respondeu',
  mpSinLib:'a biblioteca de multijogador não carregou',
  mpSalio:'{n} saiu da partida',
  chat1:'oi!', chat2:'boa', chat3:'ufa', chat4:'gg',
  calBaja:'BAIXA',
  calMedia:'MÉDIA',
  calAlta:'ALTA',
