#!/usr/bin/env python3
"""Hornea los assets de Rezona de VIGILIA y escribe partes/i_assets.js.

    python3 herramientas/vigilia/hornear.py [carpeta_con_los_glb_y_el_png]

Los crudos NO se versionan: los `task_id` estan en assets/vigilia/tareas.json y se
...
ENT = sys.argv[1] if len(sys.argv) > 1 else '/tmp/rez_vig/assets/vigilia'
#          nombre       lado del jpeg, calidad, rugosidad
#  El tablon y el bol se miran a treinta centimetros del ojo TODO el juego, asi
#  que llevan el jpeg grande; el resto son muebles a tres metros en penumbra.
MODELOS = [('tablon', 512, 86, 0.86), ('bol', 512, 86, 0.34), ('criatura', 448, 82, 0.72),
           ('puerta', 384, 80, 0.78), ('silla', 320, 78, 0.80), ('ropero', 384, 80, 0.76),
           ('cama', 384, 80, 0.74), ('tele', 320, 78, 0.60), ('muneca', 384, 80, 0.66),
           ('lampara', 256, 76, 0.52), ('cuadro', 320, 78, 0.72)]
...
def main():
    ...
    A['titulo'] = hornea_titulo(640)
    s = ("\n/* ══════════ LOS ASSETS DE REZONA, EN BASE64 ══════════\n"
         "   Lo escribe herramientas/vigilia/hornear.py; los task_id estan en\n"
         "   assets/vigilia/tareas.json. Nada de esto reemplaza lo dibujado por codigo\n"
