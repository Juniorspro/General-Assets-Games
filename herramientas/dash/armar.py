...
entero. Ya paso once veces en este repo.
  ...
  i_mus.js la cancion en base64 y su tempo (lo escribe hornear_musica.py), y va
           ANTES de b.js porque el nivel saca su BPM de ahi
...
ORDEN = ['a.html', 'i_mus.js', 'i_mus2.js', 'i_img.js', 'i_sfx.js', 'b.js', 'c.js', 'd.js', 'e.js', 'f.js', 'g.js', 'z.html']
