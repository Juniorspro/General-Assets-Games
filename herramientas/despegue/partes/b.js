...
const TXT = {
  es: { sub: 'LANZÁ, MEJORÁ, LLEGÁ MÁS ALTO', lanzar: 'LANZAR', taller: 'TALLER', estilos: 'ESTILOS', ajustes: 'AJUSTES',
        ...
        sinComb: 'SIN COMBUSTIBLE · PLANEANDO', tiempo: 'TIEMPO', prox: 'FALTA PARA', llegaste: 'LLEGASTE A', golpe: '¡GOLPE!', explota: 'EXPLOTÓ',
  ...
  en: { sub: 'LAUNCH, UPGRADE, GO HIGHER', lanzar: 'LAUNCH', taller: 'WORKSHOP', estilos: 'STYLES', ajustes: 'SETTINGS',
        ...
        sinComb: 'OUT OF FUEL · COASTING', tiempo: 'TIME', prox: 'NEXT LAYER IN', llegaste: 'YOU REACHED', golpe: 'HIT!', explota: 'EXPLODED',
  ...
  pt: { sub: 'LANCE, MELHORE, VÁ MAIS ALTO', lanzar: 'LANÇAR', taller: 'OFICINA', estilos: 'ESTILOS', ajustes: 'AJUSTES',
        ...
        sinComb: 'SEM COMBUSTÍVEL · PLANANDO', tiempo: 'TEMPO', prox: 'FALTA PARA', llegaste: 'VOCÊ CHEGOU A', golpe: 'BATIDA!', explota: 'EXPLODIU',
