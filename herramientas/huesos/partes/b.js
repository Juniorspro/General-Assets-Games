...
const TXT = {
  es: {
    ...
    ganaste: 'ESTÁN TODOS ABAJO', ganasteS: 'el campo se quedó quieto',
    hecho: 'TERMINADO',
    ...
    total: '{0} oleadas · {1} zonas',
    datos2: 'Oleadas {0}/{1} · Esqueletos {2} · Nivel {3} · {4}',
    /* ── LA HISTORIA ────────────────────────────────────────────────────────
       Va en el MISMO cartel que ya contaba la zona, y las cinco líneas de zona
       se reescribieron para que cuenten algo en vez de describir el decorado:
       las cinco eran ciertas y ninguna decía QUIÉN sos ni POR QUÉ estás acá.
       Son once líneas —tres de prólogo, cinco de zona, la del rey y tres de
       epílogo— y ni una más: se leen mientras se camina de una oleada a la
       otra, así que lo que no entre en cinco segundos de cartel no entra en
       ninguna parte. Lo que hacen es DAR VUELTA lo que ya estaba: el osario
       no es «los apilaron acá», es «LOS APILÉ acá». */
    p0: 'Cuarenta años cavando para la abadía. A todos los bajé yo.',
    p1: 'Anoche la tierra los devolvió, y los devolvió parados.',
    p2: 'Los enterré una vez. Los puedo enterrar dos.',
    d0: 'Acá arriba van los que no tenían nombre. Ni una piedra, ni una cruz.',
    d1: 'El agua sube y los saca. Yo ya los bajé tres veces.',
    d2: 'La abadía se quemó con ellos adentro. La llave del portón la tenía yo.',
    d3: 'Los saqué de la abadía y los apilé acá. Nadie vino a ayudarme.',
    d4: 'Y al fondo dejé al último. El que no quiso soltar la corona.',
    dRey: 'Se levanta el que enterré más hondo.',
    f0: 'El rey volvió a la tierra. La corona se la dejé debajo del brazo.',
    f1: 'Los conté de nuevo. {0}, uno por uno, como la primera vez.',
    f2: 'Mañana traigo la pala y una piedra con el nombre de cada uno.',
  },
  en: {
    ...
    ganaste: 'THEY ARE ALL DOWN', ganasteS: 'the field went quiet',
    hecho: 'FINISHED',
    ...
    total: '{0} waves · {1} zones',
    datos2: 'Waves {0}/{1} · Skeletons {2} · Level {3} · {4}',
    p0: 'Forty years digging for the abbey. I put every one of them down there.',
    p1: 'Last night the ground gave them back, and it gave them back standing.',
    p2: 'I buried them once. I can bury them twice.',
    d0: 'Up here go the ones with no name. No stone, no cross.',
    d1: 'The water rises and lifts them out. I have put them back three times.',
    d2: 'The abbey burned with them inside. I was the one holding the gate key.',
    d3: 'I dug them out of the abbey and stacked them here. Nobody came to help.',
    d4: 'And at the far end I left the last one. The one who would not let go of the crown.',
    dRey: 'The one I buried deepest is getting up.',
    f0: 'The king is back in the ground. I left the crown under his arm.',
    f1: 'I counted them again. {0}, one by one, the same as the first time.',
    f2: 'Tomorrow I bring the spade, and a stone with every name cut into it.',
  },
  pt: {
    ...
    ganaste: 'ESTÃO TODOS LÁ EMBAIXO', ganasteS: 'o campo ficou quieto',
    hecho: 'TERMINADO',
    ...
    total: '{0} ondas · {1} zonas',
    datos2: 'Ondas {0}/{1} · Esqueletos {2} · Nível {3} · {4}',
    p0: 'Quarenta anos cavando para a abadia. Fui eu que desci todos eles.',
    p1: 'Ontem à noite a terra devolveu todos, e devolveu de pé.',
    p2: 'Enterrei uma vez. Posso enterrar duas.',
    d0: 'Aqui em cima ficam os que não tinham nome. Nem pedra, nem cruz.',
    d1: 'A água sobe e os tira. Eu já os desci três vezes.',
    d2: 'A abadia queimou com eles dentro. A chave do portão era minha.',
    d3: 'Tirei-os da abadia e empilhei-os aqui. Ninguém veio ajudar.',
    d4: 'E lá no fundo deixei o último. O que não quis largar a coroa.',
    dRey: 'Levanta-se o que enterrei mais fundo.',
    f0: 'O rei voltou para a terra. A coroa deixei debaixo do braço dele.',
    f1: 'Contei de novo. {0}, um por um, como da primeira vez.',
    f2: 'Amanhã trago a pá e uma pedra com o nome de cada um.',
  },
};
