...
const LANGS = {
  es: {
    ...
    tuto: 'CÓMO SE JUEGA', tutTit: 'TUTORIAL',
    tut1: 'tocá el bloque de allá y el robot camina solo',
    tut2: 'arrastrá la pantalla: el diorama gira',
    tut3: 'la pieza naranja se mueve · tocala',
    tut4: 'ahora sí: llegá al rombo dorado',
    tutGana: '¡ESO ES TODO!', tutGanaSub: 'ya sabés jugar',
    tutDatos: 'un dedo y un robot · nada más',
  ...
  en: {
    ...
    tuto: 'HOW TO PLAY', tutTit: 'TUTORIAL',
    tut1: 'tap that block over there — the robot walks on its own',
    tut2: 'drag the screen: the diorama spins',
    tut3: 'the orange piece moves · tap it',
    tut4: 'now go: reach the golden diamond',
    tutGana: "THAT'S ALL!", tutGanaSub: 'you know how to play',
    tutDatos: 'one finger and one robot · nothing else',
  ...
  pt: {
    ...
    tuto: 'COMO SE JOGA', tutTit: 'TUTORIAL',
    tut1: 'toque naquele bloco e o robô caminha sozinho',
    tut2: 'arraste a tela: o diorama gira',
    tut3: 'a peça laranja se move · toque nela',
    tut4: 'agora sim: chegue ao losango dourado',
    tutGana: 'É SÓ ISSO!', tutGanaSub: 'você já sabe jogar',
    tutDatos: 'um dedo e um robô · nada mais',
