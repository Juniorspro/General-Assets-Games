...
const TXT = {
  en: {
    ...
    /* objetivos */
    oNum:(i) => 'OBJECTIVE '+i+' OF 5', oFinN:'THE DAY IS OVER',
    ...
    m4n:'The keys',            m4s:'Without them the truck will not start',
    ...
    aCueva:'It is blocked. There is no way through here.',
  ...
  es: {
    ...
    oNum:(i) => 'OBJETIVO '+i+' DE 5', oFinN:'EL DÍA TERMINÓ',
    ...
    m4n:'Las llaves',           m4s:'Sin ellas la camioneta no arranca',
    ...
    aCueva:'Está tapado. No se puede pasar por acá.',
  ...
  pt: {
    ...
    oNum:(i) => 'OBJETIVO '+i+' DE 5', oFinN:'O DIA ACABOU',
    ...
    m4n:'As chaves',            m4s:'Sem elas a caminhonete não pega',
    ...
    aCueva:'Está bloqueado. Não dá para passar por aqui.',
