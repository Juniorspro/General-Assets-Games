...
const TXT = {
  es: { sub:'DIEZ PISOS Y UNA PISTOLA', jugar:'JUGAR', menu:'MENÚ', sigue:'SIGUIENTE',
        ...
        finT:'Los diez pisos, sin ladrones.',
                t0:'Sos la pistola. No hay pies: lo único que te mueve es el retroceso.',
        t1:'Mantené el dedo apretado en cualquier lado de la pantalla.',
        t2:'El tiempo se frena y sale la línea. La pistola gira sola: vos elegís cuándo.',
        t3:'Soltá justo cuando la línea toque al ladrón.',
        t4:'El tiro te empujó. Apuntá para abajo y disparate para arriba: subí un piso.',
        t5:'Ya está. Limpiá el piso y seguí subiendo.',
        tut:'TUTORIAL', tutFin:'TUTORIAL HECHO',
  ...
  en: { sub:'TEN FLOORS AND ONE GUN', jugar:'PLAY', menu:'MENU', sigue:'NEXT',
        ...
        finT:'All ten floors, no thieves left.',
                t0:'You are the gun. No feet: the only thing that moves you is recoil.',
        t1:'Press and hold anywhere on the screen.',
        t2:'Time slows and the line appears. The gun spins on its own: you pick the moment.',
        t3:'Release right when the line touches the thief.',
        t4:'The shot pushed you. Aim down and shoot yourself up: climb one floor.',
        t5:'That\'s it. Clear the floor and keep climbing.',
        tut:'TUTORIAL', tutFin:'TUTORIAL DONE',
  ...
  pt: { sub:'DEZ ANDARES E UMA PISTOLA', jugar:'JOGAR', menu:'MENU', sigue:'PRÓXIMO',
        ...
        finT:'Os dez andares, sem ladrões.',
                t0:'Você é a pistola. Não tem pés: a única coisa que te move é o recuo.',
        t1:'Segure o dedo em qualquer lugar da tela.',
        t2:'O tempo desacelera e aparece a linha. A pistola gira sozinha: você escolhe quando.',
        t3:'Solte bem quando a linha tocar o ladrão.',
        t4:'O tiro te empurrou. Mire para baixo e atire para subir: suba um andar.',
        t5:'Pronto. Limpe o andar e continue subindo.',
        tut:'TUTORIAL', tutFin:'TUTORIAL FEITO',
